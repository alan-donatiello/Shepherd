...
# Dog logo, served at /logo.png so emails can reference a real hosted URL - inline
# base64 images are unreliably rendered by many email clients (Outlook in particular),
# unlike in the web app itself where embedding it directly works fine.
SHEPHERD_LOGO_B64 = ""

RESEND_API_KEY = os.environ.get("RESEND_API_KEY", "").strip()
RESEND_FROM_EMAIL = os.environ.get("RESEND_FROM_EMAIL", "Shepherd <onboarding@getshepherd.co>").strip()
# Without an explicit reply-to, replies default to RESEND_FROM_EMAIL - which is an
...
def send_welcome_email(to_email, name, org_name):
    ...
    <div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;max-width:480px;margin:0 auto;color:#0f172a;padding:8px">
      <h2 style="margin:0 0 12px;font-size:20px">Welcome to Shepherd, {first_name}</h2>
      <p style="color:#475569;line-height:1.6;margin:0 0 16px;font-size:15px">Your account for <strong>{org_name}</strong> is ready. Connect a wallet or bank account to get your first transactions classified automatically.</p>
      <p style="color:#475569;line-height:1.6;margin:0 0 28px;font-size:15px">This product is early - if anything is confusing, broken, or missing, just reply to this email.</p>
      <table cellpadding="0" cellspacing="0" border="0"><tr><td style="border-radius:8px;background:#0f172a">
        <a href="{app_url}" style="display:inline-block;padding:12px 28px;color:#ffffff;text-decoration:none;font-weight:600;font-size:14px;border-radius:8px">Go to Shepherd &rarr;</a>
      </td></tr></table>
      <table cellpadding="0" cellspacing="0" border="0" style="margin-top:40px;border-top:1px solid #e2e8f0;width:100%"><tr><td style="padding-top:20px">
        <img src="{app_url}/logo.png" width="28" height="19" alt="Shepherd" style="display:block;border-radius:4px">
      </td></tr></table>
    </div>
    """
...
def send_password_reset_email(to_email, reset_token):
    ...
    <div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;max-width:480px;margin:0 auto;color:#0f172a;padding:8px">
      ...
      <p style="color:#475569;line-height:1.6;margin:0 0 24px;font-size:15px">Click below to set a new password. This link expires in 1 hour.</p>
      <table cellpadding="0" cellspacing="0" border="0"><tr><td style="border-radius:8px;background:#0f172a">
        <a href="{reset_link}" style="display:inline-block;padding:12px 28px;color:#ffffff;text-decoration:none;font-weight:600;font-size:14px;border-radius:8px">Reset Password</a>
      </td></tr></table>
...
class Handler(SimpleHTTPRequestHandler):
    def do_GET(self):
        ...
        if self.path == "/logo.png":
            import base64
            logo_bytes = base64.b64decode(SHEPHERD_LOGO_B64)
            self.send_response(200)
